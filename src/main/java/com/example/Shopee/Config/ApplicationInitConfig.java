        ...
        return args -> {
            if (userRepository.findByUsername(ADMIN_USER_NAME).isEmpty()) {
                roleRepository.save(Role.builder()
                        .name(PredefinedRole.USER_ROLE.getRole())
                        .description("User role")
                        .build());

                Role adminRole = roleRepository.save(Role.builder()
                        .name(PredefinedRole.ADMIN_ROLE.getRole())
                        .description("Admin role")
                        .build());

                Role shopRole = roleRepository.save(Role.builder()
                        .name(PredefinedRole.SHOP_ROLE.getRole())
